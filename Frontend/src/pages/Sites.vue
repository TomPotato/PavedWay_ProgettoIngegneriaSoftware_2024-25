  ...
  <div class="drawer-side">
    <label for="my-drawer" aria-label="close sidebar" class="drawer-overlay"></label>
        <fieldset class="fieldset bg-base-200 border-base-300 w-xs h-full border p-4">
            ...
            <input v-model="info" type="text" class="input" placeholder="Informazioni del cantiere" required />
            ...
            <button class="btn btn-neutral mt-4" @click="createSites" :disabled="name || info  ||  latitude || longitude || street || stNumber || city || code || startDuration || companyName">Crea</button>
        </fieldset>
  </div>
</div>
